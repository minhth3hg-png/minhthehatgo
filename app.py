...
<div class="main-header">
    ...
    <p>Tác giả: Đỗ Minh Thế - Trường TH Vĩnh Thành - ĐT: 0377316013</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Minh Thế - Trường TH Vĩnh Thành - ĐT: 0377316013</div>", unsafe_allow_html=True)
